...
extern int LevelState;				//游戏关卡数: 1,2,3分别为第一关第二关第三关  4为每一关通关之后的附加关  5开始菜单
extern int MapLoadingState;			//判断是否进行了场景切换 1为是 0为否
extern int PatternState;					//关卡的切换模式参数，1为按照闯关模式切换关卡  2为按照剧情模式切换关卡
